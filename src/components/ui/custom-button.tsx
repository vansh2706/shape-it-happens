  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        vibescape: "bg-gradient-button hover:bg-gradient-button-hover text-primary-foreground shadow-teal hover:shadow-glow transform hover:scale-105 transition-all duration-300",
        social: "bg-card border border-border hover:bg-accent text-foreground hover:text-accent-foreground backdrop-blur-sm"
      },
      size: {
